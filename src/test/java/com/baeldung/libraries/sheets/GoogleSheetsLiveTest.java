...
//    private static final String SPREADSHEET_ID = "1q55OXHBO_d3XKdXDekT8DVZReVsQ5tBSNAgSu7H3xho";
    ...
    public void whenWriteSheet_thenReadSheetOk() throws IOException {
        ValueRange body = new ValueRange().setValues(
                Arrays.asList(
                        Arrays.asList((Object) "Expenses January"),
                        Arrays.asList((Object)"books", "30"),
                        Arrays.asList((Object)"pens", "10"),
                        Arrays.asList((Object)"Expenses February"),
        ...
        data.add(new ValueRange().setRange("D1").setValues(Arrays.asList(Arrays.asList((Object)"January Total", "=B2+B3"))));
        data.add(new ValueRange().setRange("D4").setValues(Arrays.asList(Arrays.asList((Object)"February Total", "=B5+B6"))));
        ...
        ValueRange appendBody = new ValueRange().setValues(Arrays.asList(Arrays.asList((Object)"Total", "=E1+E4")));
    ...
    public void whenUpdateSpreadSheetTitle_thenOk() throws IOException {
        ...
        UpdateSpreadsheetPropertiesRequest updateRequest =
        ...
        CopyPasteRequest copyRequest =
                new CopyPasteRequest()
                        .setSource(
                                new GridRange()
                                        .setSheetId(0)
